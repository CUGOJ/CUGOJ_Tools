...
namespace CUGOJ.RPC.Gen.Services.Base
{
  ...
  public partial class GetContestListResponse : TBase
  {
    ...
    {
      var tmp113 = new GetContestListResponse();
      if((ContestList != null))
      {
        tmp113.ContestList = this.ContestList.DeepCopy();
      }
      tmp113.NextCursor = this.NextCursor;
      if((BaseResp != null) && __isset.BaseResp)
      {
        tmp113.BaseResp = (global::CUGOJ.RPC.Gen.Base.BaseResp)this.BaseResp.DeepCopy();
      }
      tmp113.__isset.BaseResp = this.__isset.BaseResp;
      return tmp113;
    }
              ...
              {
                {
                  ...
                  ContestList = new List<global::CUGOJ.RPC.Gen.Common.ContestStruct>(_list114.Count);
                  for(int _i115 = 0; _i115 < _list114.Count; ++_i115)
                  {
                    global::CUGOJ.RPC.Gen.Common.ContestStruct _elem116;
                    _elem116 = new global::CUGOJ.RPC.Gen.Common.ContestStruct();
                    await _elem116.ReadAsync(iprot, cancellationToken);
                    ContestList.Add(_elem116);
                  }
      ...
      try
      {
        ...
        if((ContestList != null))
        {
          ...
          await oprot.WriteFieldBeginAsync(tmp118, cancellationToken);
          {
            ...
            foreach (global::CUGOJ.RPC.Gen.Common.ContestStruct _iter119 in ContestList)
            {
    ...
    {
      var tmp120 = new StringBuilder("GetContestListResponse(");
      if((ContestList != null))
      {
        tmp120.Append(", ContestList: ");
        ContestList.ToString(tmp120);
      }
      tmp120.Append(", NextCursor: ");
      NextCursor.ToString(tmp120);
      if((BaseResp != null) && __isset.BaseResp)
      {
        tmp120.Append(", BaseResp: ");
        BaseResp.ToString(tmp120);
      }
      tmp120.Append(')');
