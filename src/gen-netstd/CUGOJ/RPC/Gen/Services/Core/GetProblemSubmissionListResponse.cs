...
namespace CUGOJ.RPC.Gen.Services.Core
{
  ...
  public partial class GetProblemSubmissionListResponse : TBase
  {
    ...
    public GetProblemSubmissionListResponse()
    {
    }

    public GetProblemSubmissionListResponse(List<global::CUGOJ.RPC.Gen.Common.SubmissionStruct> Submissions) : this()
    {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                {
                  var _list166 = await iprot.ReadListBeginAsync(cancellationToken);
    ...
    {
      if (!(that is GetProblemSubmissionListResponse other)) return false;
