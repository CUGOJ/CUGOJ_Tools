...
namespace CUGOJ.RPC.Gen.Services.Base
{
  ...
  public partial class SaveRegisterRequest : TBase
  {
    ...
    {
      var tmp183 = new SaveRegisterRequest();
      if((RegisterInfo != null))
      {
        tmp183.RegisterInfo = (global::CUGOJ.RPC.Gen.Common.RegisterStruct)this.RegisterInfo.DeepCopy();
      }
      if((Base != null) && __isset.@Base)
      {
        tmp183.Base = (global::CUGOJ.RPC.Gen.Base.@Base)this.Base.DeepCopy();
      }
      tmp183.__isset.@Base = this.__isset.@Base;
      return tmp183;
    }
    ...
    {
      var tmp186 = new StringBuilder("SaveRegisterRequest(");
      if((RegisterInfo != null))
      {
        tmp186.Append(", RegisterInfo: ");
        RegisterInfo.ToString(tmp186);
      }
      if((Base != null) && __isset.@Base)
      {
        tmp186.Append(", Base: ");
        Base.ToString(tmp186);
      }
      tmp186.Append(')');
