...
namespace CUGOJ.RPC.Gen.Common
{
  public static class commonExtensions
  {
    ...
    public static Dictionary<string, string> DeepCopy(this Dictionary<string, string> source)
    {
      ...
      var tmp79 = new Dictionary<string, string>(source.Count);
      foreach (var pair in source)
        tmp79.Add((pair.Key != null) ? pair.Key : null, (pair.Value != null) ? pair.Value : null);
      return tmp79;
    }
    ...
    public static List<string> DeepCopy(this List<string> source)
    {
      ...
      var tmp80 = new List<string>(source.Count);
      foreach (var elem in source)
        tmp80.Add((elem != null) ? elem : null);
      return tmp80;
    }
